...
<head>
    ...
    <title>Purchase Request Register</title>
                            ...
                            <form class="user">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select class="form-control form-control-user" name="position_id" id="exampleFormControlSelect1">

...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <h2 class="mb-0 mb-3 text-gray-800">Update Hashtag</h2>
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control form-control-user"
                        ...
                        placeholder="Here insert hashtag name (e.g. Tech)" value="Tech" > 
                    @error('name')
                    <span class="invalid-feedback" role="alert" style="display: block !important;">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" name="color" class="form-control form-control-user"
                        id="" aria-describedby=""
                        placeholder="Here insert color hex code (e.g. FFFFFF)" value="FFFFFF"> 
                    @error('color')
                    <span class="invalid-feedback" role="alert" style="display: block !important;">
                        <strong>{{ $message }}</strong>
                    </span>

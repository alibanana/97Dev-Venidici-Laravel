...
<div class="row m-0 page-container"
    style="padding-bottom:5vw; padding-top: 5vw;background-color:#2B6CAA">
    <div class="col-md-12 p-0 wow fadeInUp" data-wow-delay="0.3s">
        <div class="row m-0">
            ...
            <div class="col-12 p-0" style="margin-top:4vw">
                ...
                <p class="normal-text" style="font-family: Rubik Regular;color:#FFFFFF">Linked In: <b> {{$candidate_detail->preferred_working_location == null ? '-' : $candidate_detail->preferred_working_location }}</b> </p>
                @endisset

...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <h3 class="mb-0 mb-3 text-gray-800"><span style="font-style:italic">Update Bootcamp Schedules</h3>
        </div>
        ...
        @method('put')
            <div class="row mt-2 mb-3">
                ...
                <div class="col-6 pt-3">
                   ...
                   <input type="text" name="title" value="Title" placeholder="Insert Title" class="form-control">
                </div>
                <div class="col-6 pt-3">
                    <label for="">Schedule Sub-Title</label>

                   <input type="text" name="subtitle" value="Sub Title" placeholder="Insert Sub Title" class="form-control">
                </div>

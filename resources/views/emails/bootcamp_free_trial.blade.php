...
<tbody>
  <tr>
    <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
      <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;width:40%" alt="" data-proportionally-constrained="true" data-responsive="false" src="http://ninetysevendev-venidici-app.herokuapp.com/assets/images/client/logo-transparent.png">
    </td>
  </tr>
</tbody>
</table>
...
<tbody>
  <tr>
    <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: 'Rubik', sans-serif; text-align: center;"><span style="font-size: 43px">Bootcamp Free Trial Application&nbsp;</span></div><div></div></div></td>
  </tr>
</tbody>
...
Alongside the first introductory week of the bootcamp, we need you to complete the initial assessment below. Your performance in this initial assessment would determine your qualification if you decide to participate in the subsequent full course, therefore we kindly remind you to complete the assessment thoroughly. So, are you ready? <br> <br>
You will need to complete the admission test which consists of analytical and basic digital questions. The assessment will be shared in email and whatsapp. Please use your full name and the email address above, which you used to apply to Venidici Bootcamp. <br> <br>
The test should be able to be finished under 60 minutes and must be submitted within 24 hours after it is given. <br> <br>
We kindly invite you to join our whatsapp group <a href="https://chat.whatsapp.com/Bf954UUI3esFpA1kdJZUMZ">https://chat.whatsapp.com/Bf954UUI3esFpA1kdJZUMZ</a>  so you’re not going to miss any valuable information regarding our next updates. <br> <br>
We hope you will find the guides and instructions useful. If you have any other questions, kindly write to us about that in our email at learn@venidici.id or by contacting us in our whatsapp number <a href="https://api.whatsapp.com/send?phone=+6287724429849&text=Halo%21%20Saya%20ingin%20bertanya%20tentang%20program%20Bootcamp%20By%20Venidici%20"> 087724429849</a>. <br> <br>
Thank you for your participation. We are hoping for the best results from your performance. <br> <br>
Best Regards,<br>
Venidici Indonesia
</span> <br> <br>
        @else
          ...
          <tbody>
            <tr>
              <td align="center" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                  <a class="btnLogin" href="{{env('APP_URL')}}/dashboard" style="display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none;;font-family:Rubik" target="_blank">View Dashboard</a>
              </td>
            </tr>

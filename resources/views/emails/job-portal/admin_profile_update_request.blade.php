...
<tbody>
  <tr>
    <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: 'Rubik', sans-serif; text-align: center;"><span style="font-size: 43px">New Bootcamp Profile Update Request&nbsp;</span></div><div></div></div></td>
  </tr>
</tbody>
...
<tbody>
  <tr>
    ...
    <div>
        ...
        <span style="font-size: 18px">Hi <b>Admin</b>! Bootcamp candidate <b>{{$candidate}}</b> has requested a profile update. Please click the button below to check the updates.</span>
    </div>
    <div></div></div></td>
  </tr>
</tbody>
          ...
          <tbody>
            <tr>
              <td align="center" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                  <a class="btnLogin" href="{{route('admin.job-portal.candidates.index')}}" style="display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none;;font-family:Rubik" target="_blank">View Candidate</a>
              </td>
            </tr>
    ...
    <tr>
      <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
        <div>
          ...
          <span style="color: #000000; font-size: 18px;"><a href="{{route('admin.job-portal.candidates.index')}}">{{route('admin.job-portal.candidates.index')}}</a></span>
        </div>
      </td>
    </tr>
  </tbody>

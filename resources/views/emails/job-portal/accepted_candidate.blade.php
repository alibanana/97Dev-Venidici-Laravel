...
<tbody>
  <tr>
    <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: 'Rubik', sans-serif; text-align: center;"><span style="font-size: 43px">Bootcamp Hiring Partner Information&nbsp;</span></div><div></div></div></td>
  </tr>
</tbody>
...
<tbody>
  <tr>
    ...
    <div>
        ...
        <span style="font-size: 18px">Congratulations <b>{{$candidate}}</b>! It gives us a lot of pleasure to inform you that <b>{{$company}}</b> has accepted you to their company! Do not forget to keep an eye out for email or whatsapp messages from the company for further information.</span> <br> <br>
        <span style="font-size: 18px">This is an automated message. Please do not reply to this. You'll need to contact Venidici directly for any follow-up questions.</span>
    </div>
    <div></div></div></td>
  </tr>
</tbody>
          ...
          <tbody>
            <tr>
              <td align="center" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                  <a class="btnLogin" href="{{route('customer.dashboard')}}" style="display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none;;font-family:Rubik" target="_blank">Go to Venidici</a>
              </td>
            </tr>
    ...
    <tr>
      <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
        <div>
          ...
          <span style="color: #000000; font-size: 18px;"><a href="{{route('index')}}">{{route('index')}}</a></span>
        </div>
      </td>
    </tr>
  </tbody>

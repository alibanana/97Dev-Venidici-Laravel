...
<tbody>
  <tr>
    <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: 'Rubik', sans-serif; text-align: center;"><span style="font-size: 43px">Bootcamp Candidate Accepted!&nbsp;</span></div><div></div></div></td>
  </tr>
</tbody>
...
<tbody>
  <tr>
    ...
    <div>
        ...
        <span style="font-size: 18px">Hi <b>Admin</b>! Bootcamp candidate <b>{{$candidate}}</b> has been accepted by <b>{{$company}}</b></span>
    </div>
    <div></div></div></td>
  </tr>
</tbody>

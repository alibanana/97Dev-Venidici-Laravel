...
<tbody>
  <tr>
    <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: 'Rubik', sans-serif; text-align: center;"><span style="font-size: 43px">Bootcamp Profile Request Rejected&nbsp;</span></div><div></div></div></td>
  </tr>
</tbody>
...
<tbody>
  <tr>
    ...
    <div>
        ...
        <span style="font-size: 18px">Hi <b>{{$candidate}}</b>! Its sad to say that our admin has reviewed and <b>rejected</b> your profile application.</span> <br> <br>
          ...
          <tbody>
            <tr>
              <td align="center" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                  <a class="btnLogin" href="{{route('candidate-detail.show_profile')}}" style="display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none;;font-family:Rubik" target="_blank">See my Profile</a>
              </td>
            </tr>
    ...
    <tr>
      <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
        <div>
          ...
          <span style="color: #000000; font-size: 18px;"><a href="{{route('candidate-detail.show_profile')}}">{{route('candidate-detail.show_profile')}}</a></span>
        </div>
      </td>
    </tr>
  </tbody>

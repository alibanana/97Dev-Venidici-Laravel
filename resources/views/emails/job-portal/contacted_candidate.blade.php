...
<tbody>
  <tr>
    ...
    <div>
        ...
        <span style="font-size: 18px">Dear <b>{{$candidate}}</b>, our hiring partner <b>{{$company}}</b> has added you to their watch list! Keep an eye out for email or whatsapp messages for further information.</span> <br> <br>

...
<tbody>
  <tr>
    <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: 'Rubik', sans-serif; text-align: center;"><span style="font-size: 43px">Bootcamp Profile Request Accepted&nbsp;</span></div><div></div></div></td>
  </tr>
</tbody>
...
<tbody>
  <tr>
    ...
    <div>
        ...
        <span style="font-size: 18px">Hi <b>{{$candidate}}</b>! Our admin has reviewed and <b>accept</b> your profile application.</span> <br> <br>

...
<tbody>
  <tr>
    <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
      <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;width:40%"
        alt="" data-proportionally-constrained="true" data-responsive="false" src="http://ninetysevendev-venidici-app.herokuapp.com/assets/images/client/logo-transparent.png">
    </td>
  </tr>
</tbody>
</table>
...
<tbody>
  <tr>
    <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: 'Rubik', sans-serif; text-align: center;"><span style="font-size: 43px">Password Changed Successfully!&nbsp;</span></div><div></div></div></td>
  </tr>
</tbody>
...
<tbody>
  <tr>
    ...
    <div>
        ...
        <span style="font-size: 18px">Seems like your Venidici account password has been changed.</span> <br>
    </div>
    <div></div></div></td>
  </tr>
</tbody>

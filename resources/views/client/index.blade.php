...
<div class="row m-0 banner-background page-container mobile-display"
    ...
    @csrf
    <div class="col-md-12 p-0 wow fadeInUp" data-wow-delay="0.3s">
        <p class="medium-heading" style="font-family: Rubik Bold;color:#FFFFFF;white-space:pre-line">{{ $configs['cms.homepage.top-section.heading']->value }}</p>
        <p class="bigger-text" style="font-family: Rubik Regular;color:#FFFFFF;">{{ $configs['cms.homepage.top-section.sub-heading']->value }}</p>
        <div class="grey-input-form" style="display: flex;align-items:center;width:100%;padding:2vw">
            <input class="normal-text" type="text" name="search" style="background:transparent;border:none;color: rgba(0, 0, 0, 0.5);font-family:Rubik Regular;width:100%" placeholder="Course Title">
        </div>
        <div class="grey-input-form" style="display: flex;align-items:center;width:100%;margin-top:3vw">
            <select name="filter" class="normal-text" style="background:transparent;border:none;color: #5F5D70;;width:100%;font-family:Rubik Regular;padding:1vw 0vw">
                <option value="None" disabled selected>Pilih Kategori</option>
                <option value="Skill Snack">Skill Snack</option>
                <option value="Woki">Woki</option>
                <option value="All">All</option>
        ...
        <button type="submit" onclick="openLoading()" class="btn-search normal-text" style="width:100%;margin-top:3vw">Search</button>
    </div>        
    </form>
</div>
...
<div class="row m-0 page-container mobile-display" style="padding-bottom:8vw;padding-top:8vw;display:none">
    ...
    <div class="col-12 p-0" style="margin-top:10vw;text-align:center">
        <p class="bigger-text" style="font-family: Rubik Medium;color:#3B3C43;white-space:pre-line">Yuk gotong royong...</p>
        <p class="medium-heading" style="font-family: Rubik Medium;color:#2B6CAA;white-space:pre-line;">Bangun
        Indonesia Emas 2045</p>
        <p class="bigger-text" style="font-family: Rubik Regular;color:#C4C4C4;white-space:pre-line;">“Karena bangsa yang maju berawal dari rakyatnya yang berkualitas”</p>
    </div>
</div>
        ...
        <div class="col-12 p-0" style="display:flex;justify-content:center">
            <a href="/online-course?cat=Featured" style="text-decoration:none">
                <div class="our-programs-card-homepage" style="margin-top:2.5vw;width:100%">
                    ...
                    <div style="padding:1.5vw">
                        <p class="bigger-text" id="card-title" style="font-family: Rubik Medium;color:#55525B;margin-bottom:1vw">Skill Snack</p>
                        <p class="our-programs-card-description normal-text" style="font-family: Rubik Regular;color:#55525B;margin-bottom:1vw;">Bukan zamannya belajar itu jadi beban, it’s a privilege! Belajar kapanpun dan dimanapun, kamu yang tentuin! Dengan recorded learning session dari berbagai topik, Venidici on Demand bawa pengalaman belajar kamu jadi seru lagi.</p>
                        <a href="/online-course?cat=Featured" class="btn-blue normal-text" style="text-decoration: none;font-family:Rubik Regular;">Explore Courses</a>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-12 p-0" style="display:flex;justify-content:center">
            <a href="/woki?cat=Featured" style="text-decoration:none">
                <div class="our-programs-card-homepage" style="margin-top:2.5vw;width:100%">
                    ...
                    <div style="padding:1.5vw">
                        <p class="bigger-text" id="card-title" style="font-family: Rubik Medium;color:#55525B;margin-bottom:1vw">Woki</p>
                        <p class="normal-text our-programs-card-description" style="font-family: Rubik Regular;color:#55525B;margin-bottom:1vw;">Buat kamu yang pengen healing baik sendiri atau bersama teman, tenang ada Woki disini! Woki akan membantu kamu meningkatkan kreativitas dan art skills diselingi dengan sesi healing. #BertumbuhDanPeduli bersama Woki.</p>
                        <a href="/woki?cat=Featured" class="btn-blue normal-text" style="text-decoration: none;font-family:Rubik Regular;">Explore Woki</a>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-12 p-0" style="display:flex;justify-content:center">
            <a href="/for-corporate/krest" style="text-decoration:none">
                <div class="our-programs-card-homepage" style="margin-top:2.5vw;width:100%">
                    ...
                    <div style="padding:1.5vw">
                        <p class="bigger-text" id="card-title" style="font-family: Rubik Medium;color:#55525B;margin-bottom:1vw">Krest</p>
                        <p class="normal-text our-programs-card-description" style="font-family: Rubik Regular;color:#55525B;margin-bottom:1vw;">Krest by Venidici hadir untuk membantu bisnis Anda meningkatkan produktivitas melalui serangkaian pelatihan secara online yang dirancang khusus sesuai dengan kebutuhan dan tujuan perusahaan.</p>
                        <a href="/for-corporate/krest" class="btn-blue normal-text" style="text-decoration: none;font-family:Rubik Regular;">Explore Krest</a>
                    </div>
                </div>
            </a>
        </div>
                ...
                <div style="display: flex;justify-content:center">
                    ...
                    <div class="course-card-blue">
                        ...
                        <div style="background:#FFFFFF;padding:1.5vw;border-radius:0px 0px 10px 10px">
                            <div style="height:4.5vw">
                                <div style="display:flex;justify-content:space-between;margin-bottom:0.5vw">
                                    <a href="/bootcamp" class="normal-text" style="font-family: Rubik Bold;margin-bottom:0px;color:#55525B;display: -webkit-box;overflow : hidden !important;text-overflow: ellipsis !important;-webkit-line-clamp: 2 !important;-webkit-box-orient: vertical !important;text-decoration:none">{{ $course->title }}</a>
                                    <!-- <i style="font-size:2vw;padding-left:0.5vw" role="button"  aria-controls="course-collapse-{{ $course->id }}" data-toggle="collapse" href="#course-collapse-{{ $course->id }}" class="fas fa-caret-down"></i>  -->
                                </div>
                                @foreach ($course->hashtags as $tag)
                                    <a class="small-text" style="font-family: Rubik Regular;margin-bottom:0px;color: rgba(85, 82, 91, 0.8);background: #FFFFFF;box-shadow: inset 0px 0px 2px #BFBFBF;border-radius: 5px;padding:0.2vw 0.5vw;text-decoration:none;">{{ $tag->hashtag }}</a>
...
<div class="mobile-display" style="display: none;">
    ...
    <div class="row m-0 page-container" style="padding-bottom: 6vw;">
        <!-- START OF FEATURE SECTION -->
        <div class="col-12 p-0 wow flash" data-wow-delay="0.2s" style="text-align: center;">
            <p class="small-heading" style="font-family: Rubik Medium;color:#3B3C43;white-space:pre-line;margin-top:3vw;">Apa yang akan kamu dapat
            dari Venidici?</p>
        </div>
        <div class="col-12 p-0" style="display:flex;justify-content:center;margin-top:2vw">
            ...
            <div id="feature-carousel-mobile" class="carousel slide" data-interval="5000" data-ride="carousel">
                <div class="carousel-inner" style="padding: 0vw 6vw;">
                    ...
                    <div class="carousel-item active">
                        <div class="card-white" style="display: flex;align-items:center;height:40vw;width:70vw">
                            <div style="margin-left:1vw;display: flex;flex-direction: column;justify-content: center;">
                                <p class="bigger-text" style="font-family: Rubik Medium;color:#3B3C43;margin-bottom:1vw">Skill Penunjang Karir</p>
                                <p class="normal-text" style="font-family: Rubik Regular;color:#3B3C43;margin-bottom:0px">Dapetin skill yang kamu mau dan taklukin karir impian melalui Venidici Bootcamp</p>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="card-white" style="display: flex;align-items:center;height:40vw;width:70vw">
                            <div style="margin-left:1vw;display: flex;flex-direction: column;justify-content: center;">
                                <p class="bigger-text" style="font-family: Rubik Medium;color:#3B3C43;margin-bottom:1vw">Healing bersama dengan teman baru!</p>
                                <p class="normal-text" style="font-family: Rubik Regular;color:#3B3C43;margin-bottom:0px">Bareng woki, healing sambil berkarya dan bercerita</p>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="card-white" style="display: flex;align-items:center;height:40vw;width:70vw">
                            <div style="margin-left:1vw;display: flex;flex-direction: column;justify-content: center;">
                                <p class="bigger-text" style="font-family: Rubik Medium;color:#3B3C43;margin-bottom:1vw">Jangan sampai perusahaan kamu kalah saing!</p>
                                <p class="normal-text" style="font-family: Rubik Regular;color:#3B3C43;margin-bottom:0px">Krest bisa bantu naikkin performa tim kamu lewat hands-on workshop yang seru</p>
                            </div>
                        </div>
                    </div>
                </div>
                <a class="carousel-control-prev"   data-bs-target="#feature-carousel-mobile" style="width:2vw" role="button"data-bs-slide="prev">
                    <img src="/assets/images/icons/arrow-left.svg" id="carousel-control-left-menu-image" style="width:5vw;z-index:99;margin-left:0px" alt="NEXT">
                    <span class="visually-hidden">Prev</span>
                </a>
                <a class="carousel-control-next"   data-bs-target="#feature-carousel-mobile" style="width:2vw"  role="button"data-bs-slide="next">
                    <img src="/assets/images/icons/arrow-right.svg" id="carousel-control-right-menu-image" style="width:5vw;z-index:99;margin-right:0px" alt="NEXT">
                    <span class="visually-hidden">Next</span>
                </a>
            </div>  
        ...
        <div class="col-12 p-0" style="text-align: center;margin-top:12vw">
            <p style="font-family: Rubik Medium;color:#3B3C43;font-size:7vw">Top <span style="font-family:Hypebeast;color:#A24A9C" >CLASSES</span> for you</p>
                <div style="display:flex;flex-wrap:wrap;justify-content:space-between;align-items:center;background: #FFFFFF;border: 2px solid rgba(157, 157, 157, 0.1);border-radius: 10px;padding:2vw">

                    <p class="normal-text btn-blue-on-hover btn-blue-active course-links" onclick="changeCourse(event, 'course-popular-mobile')" style="font-family: Poppins Medium;margin-bottom:0px;cursor:pointer;">Most Popular</p>
                    <p class=" btn-blue-on-hover course-links" onclick="changeCourse(event, 'bootcamp-mobile')" style="font-family: Poppins Medium;margin-bottom:0px;cursor:pointer;">Bootcamp</p>
                    <p class="normal-text btn-blue-on-hover course-links"  onclick="changeCourse(event, 'course-woki-mobile')" style="font-family: Poppins Medium;margin-bottom:0px;cursor:pointer;">Woki</p>
                    <p class="normal-text btn-blue-on-hover course-links" onclick="changeCourse(event, 'course-online-mobile')" style="font-family: Poppins Medium;margin-bottom:0px;cursor:pointer;margin-top:3vw">Skill Snack</p>
                    <!--
                    <p class="normal-text btn-blue-on-hover" style="font-family: Poppins Medium;margin-bottom:0px;cursor:pointer">Bootcamp</p>
                    <p class="normal-text btn-blue-on-hover" style="font-family: Poppins Medium;margin-bottom:0px;cursor:pointer">Workshop</p>
                    -->
            ...
            <div class="row m-0 p-0">
                @if(count($most_popular_courses) == 0)
                    <div style="margin-top:2vw;background: #C4C4C4;border: 2px solid #3B3C43;border-radius: 5px;padding:1vw;text-align:center">
                        <p class="bigger-text" style="font-family:Rubik Regular;color:#3B3C43;margin-bottom:0px"> <i class="fas fa-exclamation-triangle"></i> <span style="margin-left:1vw">Belum tersedia.</span></p>
                    </div>
                @endif
                @foreach($most_popular_courses as $course)
                            ...
                            <div style="background:#FFFFFF;padding:1.5vw;border-radius:0px 0px 10px 10px">
                                <div style="height:10vw">
                                    <div style="display:flex;justify-content:space-between;margin-bottom:0.5vw">
                                        ...
                                        @elseif ($course->courseType->type == 'Bootcamp')
                                            <a href="/bootcamp" class="bigger-text" style="font-family: Rubik Bold;margin-bottom:0px;color:#55525B;display: -webkit-box;overflow : hidden !important;text-overflow: ellipsis !important;-webkit-line-clamp: 1 !important;-webkit-box-orient: vertical !important;text-decoration:none;">{{ $course->title }}</a>
                ...
                <div class="col-12 p-0" style="margin-top:2vw">
                    <div style="display: flex;justify-content:center">
                        ...
                        <div class="course-card-red">
                            <div class="container">
                                <img src="{{ asset($course->thumbnail) }}" class="img-fluid" style="object-fit:cover;border-radius:10px 10px 0px 0px;width:100%;height:30vw" alt="Snow">
                                <div class="top-left card-tag normal-text" style="">Skill-Snack</div>
                                <div class="bottom-left" id="course-card-description" style="opacity:0;bottom:0;text-align:left;">
                                    <p class="small-text course-card-description" style="font-family: Rubik Regular;margin-bottom:0px;color: #FFFFFF;">{{ $course->description }}</p>
                                </div>
                            </div>
                            <div style="background:#FFFFFF;padding:1.5vw;border-radius:0px 0px 10px 10px">
                                <div style="height:10vw">
                                    <div style="display:flex;justify-content:space-between;margin-bottom:0.5vw">
                                        <a href="/woki/{{$course->title}}" class="normal-text" style="font-family: Rubik Bold;margin-bottom:0px;color:#55525B;display: -webkit-box;overflow : hidden !important;text-overflow: ellipsis !important;-webkit-line-clamp: 1 !important;-webkit-box-orient: vertical !important;text-decoration:none;">{{ $course->title }}</a>
                                        <!-- <i style="font-size:2vw;padding-left:4vw;font-size:4vw" role="button"  aria-controls="course-collapse-{{ $course->id }}" data-toggle="collapse" href="#course-collapse-{{ $course->id }}" class="fas fa-caret-down"></i> -->
                                    </div>
                                    @foreach ($course->hashtags as $tag)
                                        <a class="small-text" style="font-family: Rubik Regular;margin-bottom:0px;color: rgba(85, 82, 91, 0.8);background: #FFFFFF;box-shadow: inset 0px 0px 2px #BFBFBF;border-radius: 5px;padding:0.2vw 0.5vw;text-decoration:none;">{{ $tag->hashtag }}</a>
                                ...
                                <div id="star-section" style="display:flex;align-items:center;margin-top:1vw;padding-bottom:1vw">
                                    ...
                                    <div style="display: flex;justify-content:center;margin-left:1vw">
                                        @for ($i = 1; $i < 6; $i++)
                                            @if ($i <= $course->average_rating)
                                                @if ($i == 1)
                                                    <i class="small-text" style="color:#F4C257;" class="fas fa-star"></i>
                                                @else
                                                    <i class="small-text" style="margin-left:0.5vw;color:#F4C257;" class="fas fa-star"></i>
                                                @endif
                                            @else
                                                @if ($i == 1)
                                                    <i class="small-text" style="color:#B3B5C2;" class="fas fa-star"></i>
                                                @else
                                                    <i class="small-text" style="margin-left:0.5vw;color:#B3B5C2;" class="fas fa-star"></i>
                                                @endif
                                            @endif
                                        @endfor
                                    </div>
                        ...
                        <div class="course-card-green">
                            ...
                            <div style="background:#FFFFFF;padding:1.5vw;border-radius:0px 0px 10px 10px">
                                <div style="height:10vw">
                                    ...
                                    @foreach ($course->hashtags as $tag)
                                        <a class="normal-text" style="font-family: Rubik Regular;margin-bottom:0px;color: rgba(85, 82, 91, 0.8);background: #FFFFFF;box-shadow: inset 0px 0px 2px #BFBFBF;border-radius: 5px;padding:0.2vw 0.5vw;text-decoration:none;">{{ $tag->hashtag }}</a>
                                    @endforeach
                                </div>
                                <div class="collapse" id="course-collapse-{{ $course->id }}" style="margin-top:0.5vw">
        ...
        <!-- Bootcamp -->
        <div class="course-content" id="bootcamp-mobile" style="display:none">
            <div class="row m-0 p-0">
                @if(count($bootcamps) == 0)
                    <div style="margin-top:2vw;background: #C4C4C4;border: 2px solid #3B3C43;border-radius: 5px;padding:1vw;text-align:center">
                        <p class="sub-description" style="font-family:Rubik Regular;color:#3B3C43;margin-bottom:0px"> <i class="fas fa-exclamation-triangle"></i> <span style="margin-left:1vw">Belum tersedia.</span></p>
                    ...
                    <div style="display: flex;justify-content:center">
                        ...
                        <div class="course-card-blue">
                            ...
                            <div style="background:#FFFFFF;padding:1.5vw;border-radius:0px 0px 10px 10px">
                                <div style="height:10vw">
                                    <div style="display:flex;justify-content:space-between;margin-bottom:0.5vw">
                                        <a href="/bootcamp" class="normal-text" style="font-family: Rubik Bold;margin-bottom:0px;color:#55525B;display: -webkit-box;overflow : hidden !important;text-overflow: ellipsis !important;-webkit-line-clamp: 1 !important;-webkit-box-orient: vertical !important;text-decoration:none;font-size:4vw">{{ $course->title }}</a>
                                        <!-- <i style="font-size:2vw;padding-left:4vw;font-size:4vw" role="button"  aria-controls="course-collapse-{{ $course->id }}" data-toggle="collapse" href="#course-collapse-{{ $course->id }}" class="fas fa-caret-down"></i>  -->
                                    </div>
                                    @foreach ($course->hashtags as $tag)
                                ...
                                <div style="display: flex;justify-content:space-between;align-items:center;margin-top:1vw">
                                    @if ($course->bootcampCourseDetail->bootcamp_full_price == 0)
                                        <p style="font-family: Rubik Medium;margin-bottom:0px;color:#55525B;font-size:3.5vw">-</p>
                                    @else
                                        <p style="font-family: Rubik Medium;margin-bottom:0px;color:#55525B;font-size:3.5vw">Rp{{ number_format($course->bootcampCourseDetail->bootcamp_full_price, 0, ',', ',') }}</p>
                                    @endif
                                    <a href="/bootcamp" class="course-card-button" style="font-size:3.5vw">Enroll Now</a>
                                </div>
...
<div class="row m-0 page-container mobile-display" style="display:none;background:#F6F6F6">
    ...
    <div class="col-12 testimony-background wow flipInX" data-wow-delay="1s" style="padding-top:4vw;padding-bottom:4vw;">
        <div style="display: flex;justify-content:center">
            ...
            <div>
                <!-- BIG TESTIMONY CARD -->
                <div class="testimony-card" style="width: 100%;padding:1vw !important">
                    <p class="small-text" style="font-family: Rubik Regular;color:#000000; display: -webkit-box;
                    overflow : hidden !important;
                    text-overflow: ellipsis !important;
                    -webkit-line-clamp: 5 !important;
                    -webkit-box-orient: vertical !important;margin-top:2vw">{{ $fake_testimonies_big[0]->content }}</p>
                    <div style="display: flex;justify-content:center">
                        @for ($i = 1; $i < 6; $i++)
                            @if ($i <= $fake_testimonies_big[0]->rating)
                                @if ($i == 1)
                ...
                <!-- SMALL TESTIMONY CARD -->
                <div class="testimony-card" style="margin-top: 2vw;width: 100%;float:right">
                    <p class="small-text" style="font-family: Rubik Medium;color:#000000;margin-bottom:0.4vw;">{{ $fake_testimonies_small[0]->rating }}/5</p>
                    <div style="display: flex;justify-content:center">
                        @for ($i = 1; $i < 6; $i++)
                            @if ($i <= $fake_testimonies_small[0]->rating)
            ...
            <div style="margin-left: 2vw">
                    <!-- SMALL TESTIMONY CARD -->
                    <div class="testimony-card" style="width: 100%;">
                    <p class="small-text" style="font-family: Rubik Medium;color:#000000;margin-bottom:0.4vw;">{{ $fake_testimonies_small[1]->rating }}/5</p>
                    <div style="display: flex;justify-content:center">
                        @for ($i = 1; $i < 6; $i++)
                            @if ($i <= $fake_testimonies_small[1]->rating)
                ...
                <!-- END OF SMALL TESTIMONY CARD -->
                <!-- BIG TESTIMONY CARD -->
                <div class="testimony-card"  style="width: 100%;margin-top:2vw">
                    <p class="small-text" style="font-family: Rubik Regular;color:#000000;margin-top:2vw">{{ $fake_testimonies_big[1]->content }}</p>
                    <div style="display: flex;justify-content:center">
                        @for ($i = 1; $i < 6; $i++)
                            @if ($i <= $fake_testimonies_big[1]->rating)
                                @if ($i == 1)
        ...
        <div style="display:flex;align-items:center;justify-content:center">
            ...
            <a href="#menjadi-pengajar" style="text-decoration:none">
                <div class="rounded-card rounded-card-pengajar" style="padding:2vw;height:44vw;text-align:center;width:42vw;display: flex;flex-direction: column;justify-content: space-between;align-items:center;margin-right:2vw">
                    <p class="normal-text" id="card-title" style="color:#3B3C43;font-family:Rubik Medium;">Menjadi Pengajar</p>
            ...
            <a href="#menjadi-kolaborator" style="text-decoration:none">
                <div class="rounded-card rounded-card-collaborator" style="padding:2vw;height:44vw;text-align:center;width:42vw;display: flex;flex-direction: column;justify-content: space-between;align-items:center;margin-right:2vw">
                    <p class="normal-text" id="card-title" style="color:#3B3C43;font-family:Rubik Medium;">Menjadi Kolaborator</p>
...
window.addEventListener("load", function(){
    animatethis($('#collaborators-slider'), 15000);
});
</script>

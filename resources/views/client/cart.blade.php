    ...
    <div class="col-md-8 col-xs-12 p-0" style="">
        <div class="page-container-left " style="padding-top:11vw;padding-right:5vw">
            <div class="" style="display:flex;justify-content:space-between;align-items:center">
                ...
                <p class="small-text desktop-display" style="font-family:Rubik Regular;color:#CE3369;" >*Please check your cart and complete the Shipping Details form before payment</p>
            </div>
            <p class="small-text mobile-display"  style="font-family:Rubik Regular;color:#CE3369;display:none">*Please check your cart and complete the Shipping Details form before payment</p>

...
<div class="row page-container m-0 krest-background" style="padding-top:10vw;display:flex;align-items:center">
    <div class="col-6 p-0">
        ...
        <a href="#programs-section" class="btn-blue normal-text" style="text-decoration: none;font-family:Rubik Regular;padding:1vw 2.5vw">Explore Bootcamp</a>
...
<div class="row m-0 page-container krest-history-background" style="padding-top:2vw;padding-bottom:2vw">
    ...
    <div class="col-6" style="padding-right:2vw">
        ...
        <p class="big-heading" style="font-family: Rubik Bold;color:#3B3C43">Apa itu Bootcamp?</p>
...
<!-- START OF OUR CURRICULUM SECTION -->
<div class="row m-0 page-container" style="padding-top:4vw;padding-bottom:4vw;background-color:#F6F6F6">
    ...
    <div class="col-4" style="display:flex;justify-content:flex-start">
...
<div class="row m-0 page-container" style="padding-top:4vw;padding-bottom:4vw;">
    <div class="row m-0" style="padding-top:4vw">
        <div class="col-5 wow fadeInLeft" data-wow-delay="0.3s" style="display: flex;flex-direction: column;justify-content: center;">
            <div id="feature-carousel" class="carousel slide" data-interval="5000" data-ride="carousel">
                <div class="carousel-inner" style="text-align:center">
                    
                    <div class="carousel-item active" >
                        <img src="/assets/images/client/Mentor_Dummy.png" style="width:15vw;height:15vw;objec-fit:cover" class="img-fluid" alt="Image 1">
                        <p class="bigger-text" style="font-family: Rubik Bold;color:#3B3C43;margin-top:2vw;margin-bottom:0.5vw">Gabriel Amileano Vidyananto</p>
                        <p class="normal-text" style="font-family: Rubik Regular;color:#3B3C43">Product Manager @ Blibli.com</p>
                ...
                <a class="carousel-control-prev"   data-bs-target="#feature-carousel" style="width:2vw;" role="button"data-bs-slide="prev">
                    <img src="/assets/images/icons/arrow-left.svg" id="carousel-control-left-menu-image" style="width:2vw;z-index:99;margin-left:10vw" alt="NEXT">
                    <span class="visually-hidden">Prev</span>
                </a>
                <a class="carousel-control-next"   data-bs-target="#feature-carousel" style="width:2vw"  role="button"data-bs-slide="next">
                    <img src="/assets/images/icons/arrow-right.svg" id="carousel-control-right-menu-image" style="width:2vw;z-index:99;margin-right:10vw" alt="NEXT">
        ...
        <div class="col-7" style="display:flex;justify-content:flex-end">
            <div>
                <p class="sub-description" style="font-family: Rubik Medium;color:#2B6CAA">Our Mentors</p>
                <p class="big-heading" style="font-family: Rubik Bold;color:#3B3C43">Mentor yang berpengalaman dan ahli di bidangnya  </p>
                <p class="normal-text" style="font-family: Rubik Regular;color:#000000;white-space:pre-line;padding-top:1vw">Venidici memberikan berbagai macam program yang dapat diikuti oleh masyarakat luas. Mulai dari bla bla bla dan ini adalah sebuah bla bla. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Erat urna commodo eget sem. 
                </p>
            </div>
        </div>
    </div>
...
<!-- START OF CAREER SUPPORT SECTIONN -->
<div class="row m-0 page-container" style="padding-top:4vw;padding-bottom:4vw;background-color:#F6F6F6">

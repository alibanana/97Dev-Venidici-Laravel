...
<div class="desktop-display">
    ...
    <div class="row m-0 page-container faq-background" style="padding-top:6vw;padding-bottom:6vw">
        <div class="col-12 p-0" style="text-align:center">
            <p class="big-heading" style="font-family: Rubik Medium;color:#3B3C43">Frequently Asked <span style="font-family:Hypebeast;color:#CE3369">Questions</span> </p>
        </div>

...
<div class="row m-0 banner-background page-container woki-mobile-container desktop-display" style="height:40vw;padding-top:16vw;text-align:center">
    ...
    <div class="col-md-12 p-0">
        ...
        berkreasi dan berkarya! Lepasin stress kamu sambil
        tingkatin kreativitas dan art skill bareng Woki.
        #BertumbuhdanPeduli bersama Woki.</p>
        
        <a href="#search-course-section" class="sub-description btn-pink" style="font-family: Rubik Regular;margin-bottom:0px;cursor:pointer;width:100%;margin-top:5vw;padding:0.8vw 1vw;text-decoration:none;color:#FFFFFF">Search Woki</a>
...
<div class="row m-0 course-list-banner-background page-container mobile-display" style="height:100vw;padding-top:16vw;text-align:center;display:none">
    <div class="col-md-12 p-0">
        <p class="medium-heading" style="font-family: Rubik Bold;color:#FFFFFF;white-space:pre-line" >Woki</p>
        <p class="bigger-text" style="font-family: Rubik Regular;color:#FFFFFF;white-space:pre-line;margin-bottom:3vw;" >Partner terbaik kamu untuk healing bareng lewat
        berkreasi dan berkarya! Lepasin stress kamu sambil
        tingkatin kreativitas dan art skill bareng Woki.
        #BertumbuhdanPeduli bersama Woki.</p>
        
        <a href="#search-course-section" class="normal-text btn-pink" style="font-family: Rubik Regular;margin-bottom:0px;cursor:pointer;width:100%;margin-top:5vw;padding:0.8vw 1vw;display:inline-block;text-align:center;text-decoration:none">Search Woki</a>
            ...
            <div class="carousel-inner" style="padding: 0vw 3.5vw;">
                ...
                <div class="carousel-item active">
                    <div class="card-white height-card-white-mobile" >
                        <div style="display:flex;align-items:center">   
                            <img src="/assets/images/client/Default_Display_Picture.png" style="width:4vw;border-radius:10px" class="img-fluid desktop-display" alt="">
                            <div style="margin-left:1vw">
                                <p class="sub-description" id="user-font-size-mobile" style="font-family: Rubik Medium;color:#55525B;margin-bottom:0vw">@wishnumurti</p>
                        ...
                        <p class="normal-text" style="font-family: Rubik Regular;color:#55525B;margin-top:1vw;">In those 4 hours, I got a lot of insights about business case competition, all the details from the framework used to the way of deliver analysis & solution so that it can be presented well to the jury</p>
                    </div>
                </div>
                @endif
                ...
                <div class="carousel-item @if($loop->first) active @endif">
                    <div class="card-white height-card-white-mobile" >
                        ...
                        <p class="normal-text" style="font-family: Rubik Regular;color:#55525B;margin-top:1vw;">{{$review->description}}</p>
                    </div>
                </div>
                @endforeach
...
<div class="row m-0 page-container" id="search-course-section" style="padding-top:4vw;padding-bottom:8vw">   
    <div class="col-12 p-0" style="text-align:center">
        <p class="medium-heading" style="font-family: Rubik Medium;color:#55525B;margin-top:1vw;margin-bottom:0px">Find your woki course here!</p>
        <div style="display: flex;margin-top:2vw;justify-content:center;">
            <div  class="grey-input-form" style="display: flex;align-items:center">
                ...
                <form action="" method="GET">
                    <input type="text" name="search" value="{{ Request::get('search') }}" type="search" class="small-text search-course-title-input-width" style="background:transparent;border:none;margin-left:1vw;color: rgba(0, 0, 0, 0.5);width:15vw" placeholder="Woki Title">
    ...
    -->
    <!-- MOST POPULAR -->
    <div class="course-content desktop-display" id="course-popular">
    ...
    <div class="course-content mobile-display" id="course-popular" style="display:none">
        <div class="row m-0 p-0">
            @if(count($courses) == 0)
            <div style="margin-top:2vw;background: #C4C4C4;border: 2px solid #3B3C43;border-radius: 10px;padding:1vw;text-align:center">

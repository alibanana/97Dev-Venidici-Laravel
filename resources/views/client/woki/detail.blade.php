...
<div class="row m-0 page-container woki-detail-bg no-padding" style="padding-top:11vw;padding-bottom:10vw">
    ...
    <div class="col-12 col-md-9 pr-0" >
        <div style="">
            ...
            <!-- start mobile section cart  -->
            <div class="col-3 p-0 mobile-display" style="display:none;width:100%;margin-top:4vw">
                @if(session('success'))
                    <!-- ALERT MESSAGE -->
        ...
        @else
        <div id="perlengkapan-carousel" style="margin-top:2vw" class="carousel slide desktop-display" data-interval="5000" data-ride="carousel">
                ...
                @foreach ($course->artSupplies as $supply)
                    ...
                    <div class="col-6 col-md-4">
                        ...
                        <div class="perlengkapan-card-red">
                            <img src="{{asset($supply->image)}}" class="img-fluid" style="object-fit:contain;border-radius:10px 10px 0px 0px;width:100%;height:14vw" alt="Snow">
                            <div style="text-align:center">
            ...
            <div class="row m-0 " style="" >
                ...
                @foreach ($course->artSupplies as $supply)
                    ...
                    <div class="col-6 p-0 pt-1" >
                        <!-- START OF ONE PERLENGKAPAN COURSE CARD -->
                        <div class="perlengkapan-card-red">
                            <img src="{{asset($supply->image)}}" class="img-fluid" style="object-fit:contain;border-radius:10px 10px 0px 0px;width:100%;height:23vw;padding-top:2vw" alt="Snow">
                            <div style="text-align:center">
                                <p class="normal-text" style="margin-top:1vw">{{$supply->name}}</p>
                            </div>
                        </div>
    ...
    <div class="col-12 p-2" style="margin-top:3vw">
        ...
        <div class="course-content" id="course-online" style="margin-top:2vw">
                <div class="row m-0 p-0">
                    ...
                    <div class="col-12 col-md-4 p-0" >
                        <div style="padding-top:2vw;display: flex;@if($loop->iteration % 3 == 1) justify-content:flex-start @elseif ($loop->iteration % 3 == 2)justify-content:center @elseif ($loop->iteration % 3 == 0) justify-content:flex-end @endif">
                            <!-- START OF ONE RED COURSE CARD -->
                            @if ($course->courseType->type == "Course")
                            <div class="course-card-green" style=>
                            ...
                            @endif
                                <div class="container">
                                    <img src="{{ asset($course->thumbnail) }}" class="img-fluid online-course-image" style="object-fit:cover;border-radius:10px 10px 0px 0px;width:100%;height:14vw" alt="Course's thumbnail not available..">

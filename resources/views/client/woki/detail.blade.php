...
<div class="row m-0 page-container woki-detail-bg" style="padding-top:11vw;padding-bottom:10vw">
    ...
    <div class="col-9" >
        <div style="padding-right:10vw">
            ...
            <p class="small-heading" style="font-family:Rubik Medium;color:#3B3C43;margin-bottom:0px">Sertifikat menjadi komedian lucu</p>
            ...
            <a class="small-text" style="font-family: Rubik Regular;margin-bottom:0px;color: rgba(85, 82, 91, 0.8);background: #FFFFFF;box-shadow: inset 0px 0px 2px #BFBFBF;border-radius: 5px;padding:0.2vw 0.5vw;text-decoration:none;">Business</a>
            ...
            <div style="margin-top:2vw">
                <iframe style="width:42vw;height:25vw;display:block;object-fit: cover;margin-top:2vw;border-radius:10px" 
                    src="https://www.youtube.com/embed/aLqZYlmzNCY">
                </iframe>
            </div>
        ...
        <div  class="bigger-text profil-content" id="tentang-course"  style="margin-top:1vw">
            ...
            "Business Competition is a way to accelerate knowledge"  Ada yang pernah dengar pepatah ini? Pepatah ini mungkin merupakan alasan bagi beberapa orang untuk mengikuti business competition. Kompetisi bisnis memiliki banyak sekali keuntungan seperti koneksi, ilmu, dan pengalaman. Bukan hanya itu, di beberapa business competition, kamu bahkan bisa mendapatkan uang yang cukup besar lho apabila kamu menang.  Namun untuk memenangkan business competition ini bukanlah hal yang mudah. Kompetisi ini biasanya diisi oleh orang-orang dengan daya juang dan ilmu yang tinggi. Business competition tidak akan bisa dimenangkan tanpa persiapan yang baik.  Oleh karena itu, kami menyediakan rekaman webinar dari "Path to winning Business Competition" yang diselenggarakan 20 December 2020 lalu. Acara ini akan diisi oleh 3 pembicara keren yaitu Kak Novika Endini yang akan membawakan topik "Business Plan", Kak Valda Izah yang akan membawakan topik "Marketing Plan", dan Kak Khairul Arifin yang akan membawakan topik "Business Case". Rekaman webinar ini akan dibagi menjadi 4 bagian, yaitu Overview, Room Business Case, Room Business Plan, dan Room Marketing Plan.  Dengan mengikuti course ini, kamu akan lebih paham tentang bagaimana caranya untuk memenangi business competition!
            </p>
        </div>
    ...
    <div class="col-3 p-0" >
        ...
        <div class="course-detail-card-red">
            <p class="small-heading price-content" id="dengan-seni" style="font-family:Rubik Bold;color:#3B3C43;margin-bottom:0px">Rp300,0000</p>
            <p class="small-heading price-content" id="tanpa-seni" style="font-family:Rubik Bold;color:#3B3C43;margin-bottom:0px;display:none">Rp250,0000</p>
            ...
            @csrf
                ...
                <div class="form-check" style="margin-top:1vw">
                    <input onclick="changePrice(event, 'dengan-seni',300000)" class="form-check-input price-links" type="radio" name="flexRadioDefault" id="flexRadioDefault1" checked>
                ...
                <div class="form-check" style="margin-top:0.5vw">
                    <input onclick="changePrice(event, 'tanpa-seni',250000)" class="form-check-input price-links" type="radio" name="flexRadioDefault" id="flexRadioDefault2">
...
<script>
    function changePrice(evt, categoryName, price) {

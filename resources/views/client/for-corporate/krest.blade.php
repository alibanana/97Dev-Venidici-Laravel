            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div style="display:flex;justify-content:space-between;align-items:center;">
                        ...
                        <div  class="auth-input-form" style="display: flex;align-items:center;width:48%">
                            <i style="color:#DAD9E2" class="fas fa-envelope popup-krest-font"></i>
                    ...
                    <div  class="auth-input-form" style="display: flex;align-items:center;margin-top:1vw">
                        <i style="color:#DAD9E2" class="fas fa-address-card popup-krest-font"></i>
...
<div class="row page-container m-0 krest-background desktop-display" style="padding-top:10vw;display:flex;align-items:center">
    ...
    <div class="col-12 col-md-6 p-0 wow fadeInRight " data-wow-delay="0.3s" style="text-align:center">
...
<div class="row m-0 page-container mobile-display" id="programs-section" style="padding-top:4vw;padding-bottom:4vw;background-color:#F6F6F6;display:none">
    ...
    <div class="program-content-mobile"  id="available-programs-mobile">
        ...
        <!-- START OF CAROUSEL -->
        <div id="mobile-perlengkapan-carousel" style="margin-top:2vw" class="carousel slide" data-interval="5000" data-ride="carousel">
            <div class="carousel-inner" style="padding: 0vw 2vw;">
                @php $card_counter = 0; @endphp
                @foreach ($programs as $program)
                    @php $card_counter++; @endphp
                    ...
                    @endif
                        <div class="col-12" style="display:flex;justify-content:center">
                            ...
                            <div class="course-card-blue">
                                <div class="container">
                                    <img @if($program->thumbnail != null) src="{{ asset($program->thumbnail) }}" @else src="/assets/images/client/course-card-image-dummy.png" class="img-fluid image-krest-card-mobile" @endif  alt="Snow">
                                    <div class="top-left card-tag small-text" >Krest</div>
                                </div>
            ...
            <a class="carousel-control-prev"   data-bs-target="#mobile-perlengkapan-carousel" style="width:2vw" role="button"data-bs-slide="prev">
                <i class="fas fa-arrow-left big-heading" id="carousel-control-right-menu-image" style="width:1vw;z-index:99;margin-right:8.5vw;color:rgba(43, 108, 170, 0.5);" alt="PREV"></i>

                <span class="visually-hidden">Prev</span>
            </a>
            <a class="carousel-control-next"   data-bs-target="#mobile-perlengkapan-carousel" style="width:2vw" role="button"data-bs-slide="next">
                <i class="fas fa-arrow-right big-heading" style="width:1vw;z-index:99;margin-right:0px;color:rgba(43, 108, 170, 0.5);" alt="NEXT"></i>
                <span class="visually-hidden">Next</span>
            </a>
        </div> 
...
<script>
    function changeProgramsMobile(evt, categoryName) {
        var i, tabcontent, tablinks;
        tabcontent = document.getElementsByClassName("program-content-mobile")
        for (i = 0; i < tabcontent.length; i++) {
            tabcontent[i].style.display = "none";
        }
        tablinks = document.getElementsByClassName("program-links-mobile");
        for (i = 0; i < tablinks.length; i++) {
            tablinks[i].className = tablinks[i].className.replace("btn-blue-active", "btn-blue-bordered");
        }
        document.getElementById(categoryName).style.display = "block";

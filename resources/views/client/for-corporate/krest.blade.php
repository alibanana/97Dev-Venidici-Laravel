...
<div class="row page-container m-0 krest-background" style="padding-top:10vw;display:flex;align-items:center">
    <div class="col-6 p-0">
        ...
        <a href="#" class="btn-blue normal-text" style="text-decoration: none;font-family:Rubik Regular;padding:1vw 2.5vw">Explore Krest</a>
        ...
        <div class="row m-0">
            <div class="col-6">
                <div class="krest-card" style="">   
                    ...
                    <p id="krest-card-title" class="normal-text" style="font-family:Rubik Medium;margin-top:1vw">Customer Experience</p>
                    <p id="krest-card-description" class="very-small-text" style="font-family:Rubik Regular;color:#FFFFFFmargin-top:1vw">Customer Experience yang sigap menangangani dan mengayomi setiap user yang memiliki kesulitan dalam mengakses venidici dan mencerna informasi materi yang ada</p>
                </div>
            </div>
            <div class="col-6">
                <div class="krest-card" style="">   
...
<div class="row m-0 page-container" style="padding-top:4vw;padding-bottom:4vw;background-color:#F6F6F6">
    ...
    <div style="display:flex;justify-content:center;align-items:center;margin-top:2vw">
        <button type="submit" class="btn-blue normal-text" style="text-decoration: none;font-family:Rubik Regular;padding:0.2vw 2.5vw;margin-right:1vw;border:none">
            Available Programs
        </button>
        <button type="submit" class="btn-blue normal-text" style="text-decoration: none;font-family:Rubik Regular;padding:0.2vw 2.5vw;margin-left:1vw;border:none">
            On Demand Programs
        </button>
    </div>
    <div style="text-align:center">
...
<!--
    ...
    <div class="col-12" style="text-align:center">
        ...
        <p class="sub-description" style="font-family: Rubik Regular;color:#55525B;margin-top:2vw">Tanyakan kami apapun dan kami senang membantu</p>
            <div>
                <button type="submit" class="btn-blue normal-text" style="text-decoration: none;font-family:Rubik Regular;padding:0.5vw 2.5vw;100%;border:none;margin-top:1vw">
                    Kirim Pesan
                </button>
            </div>

                ...
                @csrf
                    <div class="row m-0">
                        <div class="col-6 desktop-display" style="padding-left:3.5vw;padding-top:5vw">
                            <p class="big-heading" style="font-family:Rubik Medium;color:#55525B;">Welcome Hiring Partners! </p>
                        ...
                        <div class="col-12 col-lg-6 mobile-display" style="padding:0vw 4vw;display: flex;flex-direction: column;justify-content: center;">
                            <div style="text-align:center">
                                <img src="/assets/images/client/Venidici_Icon.png" class="img-fluid" style="width:25vw" alt="LOGO">

...
<div class="row m-0 page-container online-course-detail-bg" style="padding-top:13vw;padding-bottom:10vw">
    ...
    <div class="col-8" >
        <div style="padding-right:10vw">
            <p class="small-heading" style="font-family:Hypebeast;color:#67BBA3">ONLINE COURSE</p>
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;padding-top:1vw">   
            <a class="green-tag bigger-text" style="margin-top:1vw">Muka lucu dan unik</a>
            <a class="green-tag bigger-text" style="margin-top:1vw">Another Muka lucu dan unik</a>
            <a class="green-tag bigger-text" style="margin-top:1vw">Another Muka lucu dan unik</a>
            <a class="green-tag bigger-text" style="margin-top:1vw">Another Muka 1</a>
            <a class="green-tag bigger-text" style="margin-top:1vw">Another Muka lucu dan unik</a>
        </div>
        ...
        <div style="display:flex;align-items:center;margin-top:3vw">
            <p class="sub-description profil-text profil-text-active profil-links"  onclick="changeContent(event, 'tentang-course')" style="font-family:Rubik Medium;margin-bottom:0px;cursor:pointer">Tetang <span style="font-family:Hypebeast;color:#67BBA3">ONLINE COURSE</span> ini</p>
            <p class="sub-description profil-text profil-links" onclick="changeContent(event, 'profil-pembicara')" style="font-family:Rubik Medium;margin-bottom:0px;cursor:pointer;margin-left:3vw">Profil Pembicara </p>
...
<script>
    function changeContent(evt, categoryName) {
            ...
            for (i = 0; i < tablinks.length; i++) {
                tablinks[i].className = tablinks[i].className.replace("profil-text-active", "profil-text-on-hover");
            }
            document.getElementById(categoryName).style.display = "block";
            evt.currentTarget.className += " profil-text-active";
        }

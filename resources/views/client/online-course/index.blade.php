...
<div class="row m-0 banner-background page-container online-course-mobile-container desktop-display" style="height:40vw;padding-top:16vw;text-align:center">
...
<div class="row m-0 course-list-banner-background page-container mobile-display" style="height:100vw;padding-top:16vw;text-align:center;display:none">
    <div class="col-md-12 p-0">
        <p class="medium-heading" style="font-family: Rubik Bold;color:#FFFFFF;white-space:pre-line" >Skill Snack</p>
        <p class="bigger-text" style="font-family: Rubik Regular;color:#FFFFFF;white-space:pre-line;margin-bottom:3vw;" >Fun learning anytime & anywhere! Bukan zamannya
        belajar itu jadi beban, it’s a privilege! Belajar kapanpun dan dimanapun,
        kamu yang tentuin karena Skill Snack On-Demand berisi rekaman
        course-course Venidici dengan rating terbaik.</p>
        
        <a href="#search-course-section" class="normal-text btn-blue-bordered btn-blue-bordered-active" style="font-family: Rubik Regular;margin-bottom:0px;cursor:pointer;width:100%;margin-top:5vw;padding:0.8vw 1vw;display:inline-block;text-align:center">Search Courses</a>
...
<div class="row m-0 page-container review-course-background" style="padding-bottom: 8vw;padding-top:4vw">
    ...
    <div class="col-12 col-lg-4 p-0 mobile-display" id="pt-feature-section" style="display: flex;flex-direction: column;justify-content: center;align-items:center;display:none">
    ...
    <div class="col-12 col-lg-4 p-0 desktop-display" id="pt-feature-section" style="display: flex;flex-direction: column;justify-content: center;align-items:center">
        <p class="medium-heading" style="font-family: Rubik Medium;color:#3B3C43;white-space:pre-line;">Take a look at what they say about Venidici’s Skill Snack</p>
        <!--<p class="sub-description" style="font-family: Rubik Medium;color:#3B3C43;white-space:pre-line;margin-top:2vw;margin-bottom:2vw">Want to review us?</p>
        <a href="#" class="btn-blue small-text" style="text-decoration: none;font-family:Rubik Regular;padding:0.8vw 2vw;">Review Now</a>-->

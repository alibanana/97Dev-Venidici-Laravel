...
<div class="row m-0 page-container" style="padding-bottom:4vw;padding-top:11vw">
    ...
    @if(count($my_vouchers) == 0)
            ...
            <div style="margin-top:2vw;background: #C4C4C4;border: 2px solid #3B3C43;border-radius: 10px;padding:1vw;text-align:center">
                <p class="normal-text" style="font-family:Rubik Regular;color:#3B3C43;margin-bottom:0px"> <i class="fas fa-exclamation-triangle"></i> <span style="margin-left:1vw">Voucher belum tersedia.</span></p>
            </div>
        @endif
    ...
    @foreach($my_vouchers as $promo)
        ...
        @if($loop->iteration % 3 == 1)
            <div class="col-6 col-md-4 p-0" style="display:flex; justify-content:flex-start">
        @elseif($loop->iteration % 3 == 2)
            <div class="col-6 col-md-4 p-0 " style="display:flex; justify-content:center">
        @elseif($loop->iteration % 3 == 0)
            <div class="col-6 col-md-4 p-0" style="display:flex; justify-content:flex-end">
        @endif
            ...
            ">
                ...
                <div style="width:22vw;padding:1.5vw">
                    <div style="display:flex;justify-content:space-between;align-items:center">
                        ...
                        <p class="small-text" id="padding-left-voucher" style="font-family: Rubik Regular;color:#C4C4C4;white-space:nowrap">
                        @if(!$promo->isActive)
    ...
    <div class="col-12 p-0 desktop-display" style="margin-top:4vw">
        ...
        @if(count($redeem_rules) == 0)
            <div style="margin-top:2vw;background: #C4C4C4;border: 2px solid #3B3C43;border-radius: 10px;padding:1vw;text-align:center">
                <p class="normal-text" style="font-family:Rubik Regular;color:#3B3C43;margin-bottom:0px"> <i class="fas fa-exclamation-triangle"></i> <span style="margin-left:1vw">Redeem Rule belum tersedia.</span></p>
            </div>
        @else
        <!-- START OF CAROUSEL -->
    ...
    <!-- START MOBILE REDEEM RULES -->
    <div class="col-12 p-0 mobile-display" style="margin-top:4vw;display:none">
        @if (session()->has('redeem_success'))
            <div class="col-12 " style="margin-bottom:1vw">
                <div class="alert alert-primary alert-dismissible fade show m-0 normal-text"  tyle="font-family:Rubik Regular"role="alert">
                    {{ session()->get('redeem_success') }}
        ...
        @else
        <!-- START OF CAROUSEL -->
        <div id="redeem-carousel-mobile" style="margin-top:2vw" class="carousel slide" data-interval="5000" data-ride="carousel">
            <div class="carousel-inner" style="padding: 0vw 2vw;">
                @php $card_counter = 0; @endphp
                @foreach ($redeem_rules as $rule)
                    @php $card_counter++; @endphp
            ...
            <a class="carousel-control-prev"   data-bs-target="#redeem-carousel-mobile" style="width:2vw" role="button"data-bs-slide="prev">
                <i class="fas fa-arrow-left big-heading" id="carousel-control-right-menu-image" style="width:1vw;z-index:99;margin-right:20px;color:rgba(43, 108, 170, 0.5);" alt="PREV"></i>

                <span class="visually-hidden">Prev</span>
            </a>
            <a class="carousel-control-next"   data-bs-target="#redeem-carousel-mobile" style="width:2vw" role="button"data-bs-slide="next">
                <i class="fas fa-arrow-right big-heading" style="width:1vw;z-index:99;margin-right:20px;color:rgba(43, 108, 170, 0.5);" alt="NEXT"></i>
                <span class="visually-hidden">Next</span>
            </a>
        </div> 
        <!-- END OF CAROUSEL -->

        ...
        <div class="container-modal" style="display:flex;margin:0vw !important;height:100%;overflow:auto;">
            ...
            <div class="centered white-modal">
                <div style="text-align:right">
                    <a href="/signup    " class="normal-text navbar-item" style="font-family: Poppins Medium;margin-bottom:0px;cursor:pointer;color:#2B6CAA">Sign Up <i style="margin-left:0.5vw" class="fas fa-arrow-right"></i></a>
                </div>

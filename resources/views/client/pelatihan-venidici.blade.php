...
<div class="row m-0 banner-background page-container pelatihan-venidici-mobile-container" style="height:40vw;padding-top:16vw;text-align:center">
    <div class="col-md-12 p-0">
        ...
        <p class="sub-description desktop-display" style="font-family: Rubik Regular;color:#FFFFFF;white-space:pre-line;margin-bottom:3vw" >Platform anak muda kekinian buat naklukin karir impian!</p>
        <p class="bigger-tet mobile-display" style="display:none;font-family: Rubik Regular;color:#FFFFFF;white-space:pre-line;margin-bottom:3vw" >Platform anak muda kekinian buat naklukin karir impian!</p>
        
        <a href="#search-course-section" class="desktop-display sub-description btn-blue-bordered btn-blue-bordered-active" style="font-family: Rubik Regular;margin-bottom:0px;cursor:pointer;width:100%;margin-top:5vw;padding:0.8vw 1vw">Search Courses</a>
        <a href="#search-course-section" class="mobile-display normal-text btn-blue-bordered btn-blue-bordered-active" style="display:none;font-family: Rubik Regular;margin-bottom:0px;width:100%;margin-top:5vw;padding:0.8vw 1vw;">Search Courses</a>

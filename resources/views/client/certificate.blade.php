...
<style>
  ...
  @font-face {
    font-family: rubikregular;
    font-weight: normal;
    font-style: normal; src: url('fonts/Rubik-Regular.ttf') format('truetype'); 
  }
  p{
...
<p style="font-size:2.5rem;margin-left:6rem;margin-top:16rem;color:#FFFFFF;font-family: rubikregular;">{{$name ?? 'Fernandha Dzaky'}}</p>

...
<head>
    ...
    <title>Venidici Under Construction</title>
    <style>
        * {
...
<body style="background-color:#2B6CAA">
    ...
    margin-top: -150px;">
        ...
        <p style="font-family:Rubik Bold;color:#FFFFFF;font-size:2vw;margin-top:2vw" id="title_text">Oops.. this session is expired</p>
